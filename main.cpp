...
template <typename Container> auto Paginate(const Container &c, size_t page_size)
{
...
{
    output << "{ "s << "document_id = "s << document.id << ", "s << "relevance = "s << document.relevance << ", "s
           << "rating = "s << document.rating << " }"s;
    return output;
}

template <typename Iterator> ostream &operator<<(ostream &output, const IteratorRange<Iterator> &range)
{
